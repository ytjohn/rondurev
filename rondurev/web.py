...
from rondurev import views
from rondurev import config
from rondurev.utils import DatabaseMixin
...
class Application(cyclone.web.Application):
    def __init__(self, config_file):
        handlers = [
            ...
            (r"/vm/poweroff",   views.PowerOffVM),
            (r"/vm/poweron",    views.PowerOnVM),
        ]
        ...
        if locales:
            cyclone.locale.load_gettext_translations(locales, "rondurev")
